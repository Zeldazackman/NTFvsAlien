...
<th>Criminal Status</th>
						...
						for(var/datum/data/record/R in sortRecord(GLOB.datacore.general, sortBy, order))
							...
							switch(crimstat)
								...
								if("")
									...
									crimstat = "No Record."
							dat += "<tr style=[background]><td><A href='byond://?src=[text_ref(src)];choice=Browse Record;d_rec=[text_ref(R)]'>[R.fields["name"]]</a></td>"
				...
				if(3.0)
					...
					if ((istype(active2, /datum/data/record) && GLOB.datacore.security.Find(active2)))
						dat += "<BR>\n<CENTER><B>Security Data</B></CENTER><BR>\nCriminal Status: <A href='byond://?src=[text_ref(src)];choice=Edit Field;field=criminal'>[active2.fields["criminal"]]</A><BR>\n<BR>\nMinor Crimes: <A href='byond://?src=[text_ref(src)];choice=Edit Field;field=mi_crim'>[active2.fields["mi_crim"]]</A><BR>\nDetails: <A href='byond://?src=[text_ref(src)];choice=Edit Field;field=mi_crim_d'>[active2.fields["mi_crim_d"]]</A><BR>\n<BR>\nMajor Crimes: <A href='byond://?src=[text_ref(src)];choice=Edit Field;field=ma_crim'>[active2.fields["ma_crim"]]</A><BR>\nDetails: <A href='byond://?src=[text_ref(src)];choice=Edit Field;field=ma_crim_d'>[active2.fields["ma_crim_d"]]</A><BR>\n<BR>\nImportant Notes:<BR>\n\t<A href='byond://?src=[text_ref(src)];choice=Edit Field;field=notes'>[decode(active2.fields["notes"])]</A><BR>\n<BR>\n<CENTER><B>Comments/Log</B></CENTER><BR>"
						var/counter = 1
						while(active2.fields["com_[counter]"])
							dat += "[active2.fields["com_[counter]"]]<BR><A href='byond://?src=[text_ref(src)];choice=Delete Entry;del_c=[counter]'>Delete Entry</A><BR><BR>"
							counter++
						dat += "<A href='byond://?src=[text_ref(src)];choice=Add Entry'>Add Entry</A><BR><BR>"
						dat += "<A href='byond://?src=[text_ref(src)];choice=Delete Record (Security)'>Delete Record (Security Only)</A><BR><BR>"
					else
						dat += "<B>Security Record Lost!</B><BR>"
						dat += "<A href='byond://?src=[text_ref(src)];choice=New Record (Security)'>New Security Record</A><BR><BR>"
					dat += "\n<A href='byond://?src=[text_ref(src)];choice=Delete Record (ALL)'>Delete Record (ALL)</A><BR><BR>\n<A href='byond://?src=[text_ref(src)];choice=Print Record'>Print Record</A><BR>\n<A href='byond://?src=[text_ref(src)];choice=Return'>Back</A><BR>"
				if(4.0)
					if(!length(Perp))
			...
			switch(href_list["field"])
				...
				if("criminal")
					if (istype(active2, /datum/data/record))
						...
						temp += "<ul>"
						temp += "<li><a href='byond://?src=[text_ref(src)];choice=Change Criminal Status;criminal2=none'>None</a></li>"
						temp += "<li><a href='byond://?src=[text_ref(src)];choice=Change Criminal Status;criminal2=arrest'>*Arrest*</a></li>"
						temp += "<li><a href='byond://?src=[text_ref(src)];choice=Change Criminal Status;criminal2=incarcerated'>Incarcerated</a></li>"
						temp += "<li><a href='byond://?src=[text_ref(src)];choice=Change Criminal Status;criminal2=released'>Released</a></li>"
						temp += "</ul>"
				if("rank")
