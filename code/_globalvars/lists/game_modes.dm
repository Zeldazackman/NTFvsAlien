...
GLOBAL_LIST_INIT(ranked_jobs_by_faction, list(
	FACTION_TERRAGOV = list(CAPTAIN, FIELD_COMMANDER, STAFF_OFFICER, SQUAD_LEADER, SQUAD_SMARTGUNNER, SQUAD_ENGINEER, SQUAD_CORPSMAN),
	FACTION_SOM = list(SOM_COMMANDER, SOM_FIELD_COMMANDER, SOM_STAFF_OFFICER, SOM_ASSAULT_CREWMAN, SOM_PILOT_OFFICER, SOM_MECH_PILOT, SOM_SQUAD_LEADER, SOM_SQUAD_VETERAN, SOM_SQUAD_ENGINEER, SOM_SQUAD_CORPSMAN),
))
