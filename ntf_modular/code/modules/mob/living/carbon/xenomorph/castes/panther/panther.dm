/mob/living/carbon/xenomorph/runner/panther
	caste_base_type = /datum/xeno_caste/runner/panther
	name = "Panther"
...
/mob/living/carbon/xenomorph/runner/panther/set_stat()
	. = ..()
	if(isnull(.))
		return
...
/mob/living/carbon/xenomorph/runner/panther/Initialize()
	. = ..()
	addtimer(CALLBACK(src, PROC_REF(adrenalin)), 1 SECONDS, TIMER_LOOP)

/mob/living/carbon/xenomorph/runner/panther/proc/adrenalin()
...
/mob/living/carbon/xenomorph/runner/panther/on_death()
	. = ..()
	if(prob(44.81))
