#define ACCESSORY_COLOR_NONE 0
#define ACCESSORY_COLOR_BODY 1
#define ACCESSORY_COLOR_TAIL 2
#define ACCESSORY_COLOR_TAIL_SECONDARY 3
#define ACCESSORY_COLOR_TAIL_TERTIARY 4
#define ACCESSORY_COLOR_HAIR 5
#define ACCESSORY_COLOR_EYES 6
