...
/datum/game_mode/infestation/extended_plus/proc/things_after_spawn(datum/source, mob/living/carbon/human/new_member)
	SIGNAL_HANDLER
	//no prisoner guns.
...
/datum/game_mode/infestation/extended_plus/proc/toggle_pop_locks()
